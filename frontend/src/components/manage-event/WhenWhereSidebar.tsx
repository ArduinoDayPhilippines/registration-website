  ...
  return (
    <div className="space-y-6">
      <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 md:p-6 border border-white/10">
        <h3 className="font-montserrat text-base md:text-lg font-bold text-white mb-4">
          When & Where
        </h3>
        <div className="space-y-4">
          ...
          <div className="flex gap-3 items-start p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
