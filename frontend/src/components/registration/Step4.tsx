        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-1 mt-2 sm:mt-4">
            <span className="text-xs sm:text-sm font-semibold text-primary block mb-2">
              Are you open to a scholarship/career opportunity from one of our
              sponsors? *
            </span>
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      checked={isSelected}
                      onChange={() =>
                        updateData({ isOpenToScholarship: opt as "Yes" | "No" })
                      }
                    />
                    <div
                      className={cn(
          ...
          <div className="space-y-2">
            <span className="text-[9px] sm:text-[10px] text-primary uppercase tracking-widest font-bold">
