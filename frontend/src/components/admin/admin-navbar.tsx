...
export function AdminNavbar({ activeTab }: AdminNavbarProps) {
  ...
  return (
    <>
      <nav 
        className="h-16 px-6 md:px-10 lg:px-16 flex items-center justify-between z-40 fixed top-0 left-0 right-0 backdrop-blur-md bg-black/20 border-b border-white/5 shadow-lg shadow-black/20"
      >
        ...
        <div className="flex items-center gap-8 md:gap-12">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-medium text-gray-400 uppercase tracking-wider hidden sm:inline font-urbanist">ADPH Admin</span>
          </div>
